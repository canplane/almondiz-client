...
- Each project moved to a newer frontend stack: [kpx](https://github.com/canplane/kpx) (jQuery/Bootstrap) → [udigo-ui](https://github.com/canplane/udigo-ui) (vanilla JS/CSS) → this, the first one built with a modern framework.
...
- **Organization:** [almondiz](https://github.com/almondiz) (2 frontend, 2 backend, 1 designer)
